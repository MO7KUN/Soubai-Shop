...
>>>>>>> Stashed changes
          ...
          product.label
                ...
                <td class="px-4 py-3 text-center whitespace-nowrap font-meduim">${
                  product.ref || "---"
                }</td>
                <td class="px-4 py-3 text-center whitespace-nowrap font-medium">${
                  product.label
                }</td>
                <td class="px-4 py-3 text-center whitespace-nowrap font-semibold" dir="ltr">${
                ...
                <td class="px-4 py-3 text-center">
                    <select id="productVisibilitySelector" class="bg-gray-100 p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-300" onchange="changeProductVisibility(${
                      product.id
                    })" >
                        <option value="1" ${
                ...
                <!--<td class="px-4 py-3 text-center whitespace-nowrap">${new Date(
                  product.created_at
                ...
                <td class="px-4 py-3 text-center">
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <button onclick="deleteProduct(${
                          product.id
                        })" class="bg-red-500 text-white px-3 py-1.5 rounded-full hover:bg-red-600 transition">
